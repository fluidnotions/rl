...
def test_inverted_pendulum():
    ...
    wrapped_env = gym.wrappers.RecordEpisodeStatistics(env, 50)  # Records episode-reward # type: ignore
    ...
    for seed in [1, 2, 3, 5, 8]:  # Fibonacci seeds
        ...
        for episode in range(total_num_episodes):
            ...
            while not done:
                ...
                obs, reward, terminated, truncated, info = wrapped_env.step(action) # type: ignore
